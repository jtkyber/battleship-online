...
const Navigation = ({ onRouteChange }) => {
	...
	const { setSearch, setSoundOn, setMusicOn, setShowFriendsMobile, setShowChatMobile } = useStoreActions(
		actions => ({
		...
		<nav className='nav'>
			<div className='leftNav'>
				<img
					alt='sound icon'
					src={soundIcon}
					onClick={setSoundClick}
					onTouchStart={setSoundTouch}
					className={`hasSound audioToggle soundToggle ${soundOn ? 'soundOn' : 'soundOff'}`}
				/>
				<img
					alt='music icon'
					src={musicIcon}
					onClick={setMusicClick}
					onTouchStart={setMusicTouch}
					className={`hasSound audioToggle musicToggle ${musicOn ? 'musicOn' : 'musicOff'}`}
				/>
			</div>
			<div className='rightNav'>
				{route === 'login' || route === 'register' ? (
					<>
						<img
							className='hasSound leaderboardIcon'
							src={leaderboardIcon}
							alt='leaderboard'
							value='goToLeaderboard'
					...
					!isMobile ? (
						...
						<>
							<img
								className='hasSound friendsIcon'
								src={friendsIcon}
								alt='friends'
								onClick={() => setShowFriendsMobile(!showFriendsMobile)}
							/>
							<FriendRequests />
							<img
								className='hasSound leaderboardIcon'
